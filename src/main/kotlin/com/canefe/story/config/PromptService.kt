...
class PromptService(private val plugin: Story) {
    ...
    fun getBehavioralDirectivePrompt(
        ...
        val variables = mapOf(
            ...
            "relationship_context" to if (relationshipContext.isNotEmpty()) "Relationships:\n$relationshipContext" else "",
            "npc_name" to npcName
        )
     ...
     */
    fun getQuestBookPrompt(
        loreContext: String,
        locationInfo: String,
        npcContext: String
    ): String {
        val variables = mapOf(
            "lore_context" to loreContext,
            "location_info" to locationInfo,
            "npc_context" to npcContext
        )
     ...
     */
    fun getGameMasterResponsePrompt(
        characterInformation: String,
        loreInformation: String,
        locationInformation: String
    ): String {
        val variables = mapOf(
            "character_information" to characterInformation,
            "lore_information" to loreInformation,
            "location_information" to locationInformation
        )
