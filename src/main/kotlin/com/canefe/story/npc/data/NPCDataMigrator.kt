...
class NPCDataMigrator(
        ...
        try {
            ...
            if (npcFile.exists()) {
                ...
                val conversationList =
                    config
                        .getMapList("conversationHistory")
                        .map { map ->
                            ConversationMessage(
    ...
    fun isOldFormat(npcData: NPCData): Boolean =
        npcData.getOldConversationHistory() != null &&
            npcData.getOldConversationHistory()!!.isNotEmpty() &&
    ...
    fun migrateToNewFormat(
        ...
        try {
            ...
            val recentConversations =
                npcData.getOldConversationHistory()?.takeLast(20) ?: emptyList<ConversationMessage>()
