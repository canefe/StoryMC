    ...
    private fun registerSimpleCommands() {
        ...
        CommandAPICommand("npcinit")
            ...
            .executesPlayer(PlayerCommandExecutor { player: Player, args: CommandArguments ->
                ...
                val npcContext = plugin.npcContextGenerator.getOrCreateContextForNPC(npcName) ?: run {
                    player.sendError("NPC context not found. Please create the NPC first.")
                    return@PlayerCommandExecutor
                }

                val storyLocation = plugin.locationManager.getLocation(location) ?: run {
                ...
                if (prompt.isNotEmpty()) {
                    ...
                    player.sendInfo("Generating AI context for NPC <yellow>$npcName</yellow> based on: <italic>$prompt</italic>")
        ...
        CommandAPICommand("g")
            ...
            .executesPlayer(PlayerCommandExecutor { player, args ->
                ...
                val conversation = plugin.conversationManager.getConversation(npcName) ?: run {
