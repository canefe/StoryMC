...
class MoveLocationCommand(private val commandUtils: LocationCommandUtils) {
		...
		return CommandAPICommand("move")
			...
			.executesPlayer(
				PlayerCommandExecutor { player, args ->
					...
					player.sendSuccess("Location <gold>'$locationName'</gold> updated successfully at your current location.")
				},
			)
	}
}
